...
def recognize(filename):
    ...
    prompt = "Распознай заграничный паспорт и верни данные с такими полями: Номер документа, Имя, Фамилия, Отчество, Гражданство, Дата рождения, Дата выдачи, Дата окончания срока, Пол, Место рождения. Данные в полях разделены на кирилицу и латиницу. Верни данные на латинеце"
