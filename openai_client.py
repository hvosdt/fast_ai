    ...
    completion = client.chat.completions.create(
        ...
        messages=[
            {   
                "role": "system", 
                "content": 
                    '''Ты аналитик отдела контроля качества. Дай развернутую и не шаблонную аналитику по диалогу с клиентом, который был в переписки и по телефону. Если диалогов несколько, то сделай это по каждому.
